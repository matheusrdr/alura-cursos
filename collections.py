...
assistiram = usuarios_data_science.copy() # faz uma cópia da lista
assistiram.extend(usuarios_machine_learning) # adiciona uma lista na outra
assistiram

len(assistiram)
set(assistiram) # transforma em conjunto
...
usuarios_machine_learning[3] #pega o terceiro elemento

for usuario in set(assistiram):
  print(usuario) # printa cada elemento do conjunto

usuarios_data_science = {15, 23, 43, 56}
usuarios_machine_learning = {13, 23, 56, 42}

usuarios_data_science | usuarios_machine_learning # uniao

usuarios_data_science & usuarios_machine_learning # intersecção

usuarios_data_science - usuarios_machine_learning # left join
...
usuarios_data_science ^ usuarios_machine_learning # elementos unicos de cada set
...
usuarios = frozenset(usuarios) # set nao iteravel
usuarios
...
for elemento in aparicoes: # nas chaves
  print(elemento)
...
for palavra in meu_texto.split():
  aparicoes[palavra] += 1 # melhor forma
...
def analisa_frequencia_de_letras(texto):
  ...
  proporcoes = [(letra, frequencia / total_de_caracteres) for letra, frequencia in aparicoes.items()] # list comprehension
